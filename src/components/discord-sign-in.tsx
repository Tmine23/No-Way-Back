...
export function DiscordSignInButton({ label = "Entrar con Discord", className = "" }: { label?: string; className?: string }) {
  ...
  return (
    <button onClick={signIn} className={`btn-primary flex w-fit items-center gap-2 ${className}`}>
      <DiscordIcon />
      {label}
    </button>
  );
